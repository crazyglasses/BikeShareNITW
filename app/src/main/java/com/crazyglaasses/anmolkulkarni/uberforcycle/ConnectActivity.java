...
public class ConnectActivity extends Activity implements View.OnClickListener {
    ...
    String devicename = "Windows Phone";
    String MAC = "48:86:E8:00:57:5D";
    int bool = 0;
    Button b;
    ...
    private void setBluetoothData() {
        ...
        for (BluetoothDevice device : devices) {
            out.append("\nFound device: " + device.getName() + " Add: "
                    + device.getAddress());
            if ((device.getName()).equals(devicename) && ((device.getAddress()).equals(MAC))) {
                bool = 1;
            }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.b:
                startActivity(new Intent((ConnectActivity.this), Activity.class));
                break;
        }
    }
}
